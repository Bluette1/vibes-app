    ...
    try {
      if (isLogin) {
        ...
        try {
          ...
          localStorage.setItem('transitionInterval', prefsData.preferences.image_transition_interval.toString());
          localStorage.setItem('selectedTrack', prefsData.preferences.selected_track);
      ...
      <div className="ring-book-auth">
        ...
        <div className="auth-content">
          <div className="auth-header">
            ...
            <p className="app-subtitle">{isLogin ? 'Log in to your account' : 'Create your account'}</p>
          </div>
